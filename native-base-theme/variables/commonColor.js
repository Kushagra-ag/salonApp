...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#f85f6a',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#222' : '#222',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#000' : '#000',
  sTabBarActiveTextColor: '#000',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#2874F0' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#c2c2c2',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#000' : '#000',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#F8F8F8',
  get statusBarColor() {
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#F8F8F8',
  ...
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#F8F8F8',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#F8F8F8',
